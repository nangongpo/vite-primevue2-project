  ...
  <div class="grid panel-demo">
    <div class="col-12">
      <div class="card">
        ...
        <Toolbar>
          <template #start>
            <Button label="新建" icon="pi pi-plus" class="mr-2" />
            <Button label="上传" icon="pi pi-upload" class="p-button-success" />
    ...
    <div class="col-12 md:col-6">
      <div class="card">
        <h5>AccordionPanel 手风琴面板</h5>
        <Accordion>
          <AccordionTab header="标题一" :active="true">
            <p>
    ...
    <div class="col-12 md:col-6">
      <div class="card">
        <h5>Panel 面板</h5>
        <Panel header="木兰花" :toggleable="true">
          <p>
      ...
      <div class="card">
        <h5>Fieldset 分组</h5>
        <Fieldset legend="江城子·乙卯正月二十日夜记梦" :toggleable="true">
          <p>
      ...
      <div class="card">
        <Card>
          ...
          <template #content>
            <p>
              《快乐大本营》是湖南卫视推出的嘉宾访谈游戏节目。他由何炅、谢娜、李维嘉、吴昕和杜海涛担任主持。节目主要以游戏为主，辅以歌舞和各种形式的节目。每个展览都是为艺术家们设计自己的主题。湖南卫视于1997年7月5日20:15开始播出《快乐大本营》，每周六晚20:15播出。在某种程度上，它彻底改变了综艺节目。
            </p>
          </template>
        </Card>
      </div>
    ...
    return {
      toolbarItems: [
        ...
        },
        {
          ...
          command: () => {
            window.location.href = 'https://v2.cn.vuejs.org/'
          }
        },
        {
          label: '上传',
