<template>
  <div class="exception-body">
    <div class="exception-text">
      <svg width="251" height="294" xmlns="http://www.w3.org/2000/svg">
      ...
      <!-- <img src="https://img.alicdn.com/tfs/TB11TaSopY7gK0jSZKzXXaikpXa-200-200.png')" class="Exception--exceptionImage--2V9UOqo" alt="img"> -->
    </div>
    <div class="exception-text">
    ...
    <div class="exception-text">
      <span>对不起，你没有权限访问该页面。</span>
    </div>

    <!-- <div class="exception-panel">
			<div class="exception-image">
				<img :src="$publicUrl('resource/layout/images/exception/icon-error.png')" alt="avalon-vue"/>
			</div>
